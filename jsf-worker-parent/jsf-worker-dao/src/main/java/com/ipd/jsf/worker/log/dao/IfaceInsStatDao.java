...
@Repository
public interface IfaceInsStatDao {
	
	public IfaceInsStat getByLastWeek(@Param("interfaceName")String iface, @Param("week")int week);

	public IfaceInsStat getLastWeek(IfaceInsStat ifaceInsStat);
	
	public IfaceInsStat getLastWeekRecord(String iface);
	
	public int exists(IfaceInsStat insStat);
