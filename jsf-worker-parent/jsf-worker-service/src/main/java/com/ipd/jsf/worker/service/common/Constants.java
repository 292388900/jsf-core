 ...
 */
package com.ipd.jsf.worker.service.common;
...
public class Constants {
    ...
    public static final String  SAFVERSION_KEY                        = "safversion";
     ...
     * 重试周期
     */
    public static final int DEFAULT_REGISTRY_RETRY_PERIOD          =  15 * 1000;
    ...
    //data type: 1-registry, 2-manual, 3-zookeeper
    public static final int SYN_SRC_TYPE_DB       =  1;
    public static final int SYN_SRC_TYPE_ZK       =  3;
    public static final String SYN_GROUP_VERSION_SPLIT = ":";
    /*
     * private Constants(){ }
     */
